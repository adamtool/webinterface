#!/bin/sh
java -DPROPERTY_FILE=./ADAM.properties.dev -jar server/target/web-frontend-1.0-SNAPSHOT-jar-with-dependencies.jar 2>&1 | tee adamweb-log-`date +%Y-%m-%d-%Hh%Mm%Ss`.txt &
