...
SYNT_EXCLUDING_FILES='-not -path */forallsafety/burglar/burglar.apt -not -path */forallsafety/container/container.apt -not -path */forallsafety/sendingProtocol/sendingProtocol.apt'
