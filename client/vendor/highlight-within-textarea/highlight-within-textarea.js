 ...
 *
 * @author  Will Boyd
 * Adapted by MattX to remove jQuery dependency
 * Adapted by Ann Yanich to change the export style from IIFE to 'export { ... }'
 * @github  https://github.com/MattX/highlight-within-textarea
 */
